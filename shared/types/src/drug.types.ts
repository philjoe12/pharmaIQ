// Single source of truth for all drug-related types
// Based on actual Labels.json structure
...
// Raw FDA Label structure (exactly matches Labels.json)
...
export interface LabelContent {
  ...
  // HTML content sections (as they appear in Labels.json)
...
// Processed drug data after parsing
