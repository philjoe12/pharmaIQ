        ...
        <div className="flex flex-col h-full">
            ...
            <nav className="space-y-4">
              {navItems.map((item) => (
                <a
                  ...
                  href={item.href}
                  onClick={toggleMenu}
                  className="block text-gray-700 hover:text-blue-600 font-medium py-3 px-4 rounded-lg hover:bg-gray-50 transition-colors duration-200"
                >
                  {item.label}
                </a>
              ))}
          ...
          <div className="p-6 border-t border-gray-200">
            <a 
              href="/search"
              onClick={toggleMenu}
              className="block w-full bg-gradient-to-r from-blue-600 to-teal-600 text-white text-center px-6 py-3 rounded-lg hover:from-blue-700 hover:to-teal-700 font-medium transition-all shadow-md hover:shadow-lg"
            >
              Search Drugs Now
            </a>
          </div>
