...
const LoadingComponent = ({ message = 'Loading...' }) => (<div className="flex items-center justify-center p-8 min-h-[200px]">
...
export const AdvancedDrugComparison = dynamic(() => import('../comparison/AdvancedDrugComparison'), {
...
export const SmartDrugDiscovery = dynamic(() => import('../discovery/SmartDrugDiscovery'), {
    loading: () => <LoadingComponent message="Loading drug discovery interface..."/>,
    ssr: true, // Keep SSR for better SEO
});
export const DrugComparisonTable = dynamic(() => import('../comparison/ComparisonTable'), {
    loading: () => <LoadingComponent message="Loading comparison table..."/>,
    ssr: true,
});
// Analytics components (loaded on demand)
export const WebVitalsReporter = dynamic(() => import('../analytics/WebVitals'), {
    ssr: false, // Client-side only
});
// Chart components (typically heavy with dependencies)
export const DrugEffectivenessChart = dynamic(() => import('../charts/EffectivenessChart').catch(() => ({
...
export const UserTypeSelector = dynamic(() => import('../user-type/UserTypeSelector'), {
