...
async function getAIEnhancedMetadata(drug) {
    try {
    ...
    return (<>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          {drug.label.description && (<section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">Overview</h2>
              <div className="text-gray-700" dangerouslySetInnerHTML={{ __html: drug.label.description }}/>
            </section>)}
          
          {drug.label.indicationsAndUsage && (<section className="mb-8">
          ...
          {drug.label.dosageAndAdministration && (<section className="mb-8">
          ...
          {drug.label.warningsAndPrecautions && (<section className="mb-8">
          ...
          {drug.label.adverseReactions && (<section className="mb-8">
          ...
          {drug.label.contraindications && (<section className="mb-8">
          ...
          {drug.label.clinicalPharmacology && (<section className="mb-8">
