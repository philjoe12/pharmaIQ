...
export default async function Home() {
    ...
    return (<main className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/search" className="bg-white text-blue-700 px-8 py-4 rounded-full font-semibold hover:bg-blue-50 transition-all shadow-lg hover:shadow-xl text-center">
                  Search Drugs Now
                </Link>
                <Link href="/drugs/discovery" className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-blue-700 transition-all text-center">
      ...
      {Array.isArray(drugs) && drugs.length > 0 && (<section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {drugs.map((drug) => (<Link key={drug.setId} href={`/drugs/${drug.slug}`} className="group bg-gray-50 hover:bg-white rounded-2xl p-8 transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="text-center mt-12">
              <Link href="/search" className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-8 py-4 rounded-full font-semibold hover:from-blue-700 hover:to-teal-700 transition-all shadow-lg hover:shadow-xl">
